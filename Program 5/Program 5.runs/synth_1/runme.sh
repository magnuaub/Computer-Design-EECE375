...
HD_PWD='C:/Users/LG/Program 5/Program 5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_MA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_MA.tcl
