...
REM
REM Generated by Vivado on Fri Oct 17 12:01:21 +0900 2025
...
echo "xvlog --incr --relax -prj tb_SPI_MA_vlog.prj"
call xvlog  --incr --relax -prj tb_SPI_MA_vlog.prj -log xvlog.log
